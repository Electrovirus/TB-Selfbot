...
function show_supergroup_settingsmod(msg, target)
  ...
  local text = "🔄Moderation\nAnti-Squig : ["..settings.lock_spam.."]\nAnti-Bot : ["..bots_protection.."]\nAnti-Link : ["..settings.lock_link.."]\nAnti-Flood : ["..settings.flood.."]\n\n🔁Media\n"..mutes_list(msg.to.id)..""
return text
end
...
local function run(msg, matches)
	...
	local data = load_data(_config.moderation.data)
		...
		if matches[1] == 'gpsettings' and is_momod(msg) then
			local target = msg.to.id
		...
		if matches[1] == 'iiiihelp' and not is_owner(msg) then
			text = ""
			reply_msg(msg.id, text, ok_cb, false)
		elseif matches[1] == 'iiiihelp' and is_owner(msg) then
